...
mod regressions_324;
mod regressions_325;
mod regressions_326_330;
mod regressions_331_335;
mod regressions_336_340;
mod regressions_341;
mod regressions_342_343;
mod regressions_344_346;
mod regressions_347_348;
mod regressions_349_351;
mod regressions_352_357;
mod regressions_358_367;
mod regressions_368_376;
mod regressions_377_386;
mod regressions_387_389;
mod regressions_390_395;
mod regressions_396;
mod regressions_397;
mod regressions_398_399;
mod regressions_410_411;
mod regressions_412;
mod regressions_413_414;
mod regressions_415;
mod regressions_416;
mod regressions_417;
mod regressions_418;
...
use regressions_326_330::REGRESSION_CASES_326_330;
use regressions_331_335::REGRESSION_CASES_331_335;
use regressions_336_340::REGRESSION_CASES_336_340;
use regressions_341::REGRESSION_CASES_341;
use regressions_342_343::REGRESSION_CASES_342_343;
use regressions_344_346::REGRESSION_CASES_344_346;
use regressions_347_348::REGRESSION_CASES_347_348;
use regressions_349_351::REGRESSION_CASES_349_351;
use regressions_352_357::REGRESSION_CASES_352_357;
use regressions_358_367::REGRESSION_CASES_358_367;
use regressions_368_376::REGRESSION_CASES_368_376;
use regressions_377_386::REGRESSION_CASES_377_386;
use regressions_387_389::REGRESSION_CASES_387_389;
use regressions_390_395::REGRESSION_CASES_390_395;
use regressions_396::REGRESSION_CASES_396;
use regressions_397::REGRESSION_CASES_397;
use regressions_398_399::REGRESSION_CASES_398_399;
use regressions_410_411::REGRESSION_CASES_410_411;
use regressions_412::REGRESSION_CASES_412;
use regressions_413_414::REGRESSION_CASES_413_414;
...
pub(crate) fn regression_cases() -> impl Iterator<Item = LuaCaseManifestEntry> {
    [
        ...
        REGRESSION_CASES_326_330,
        REGRESSION_CASES_331_335,
        REGRESSION_CASES_336_340,
        REGRESSION_CASES_341,
        REGRESSION_CASES_342_343,
        REGRESSION_CASES_344_346,
        REGRESSION_CASES_347_348,
        REGRESSION_CASES_349_351,
        REGRESSION_CASES_352_357,
        REGRESSION_CASES_358_367,
        REGRESSION_CASES_368_376,
        REGRESSION_CASES_377_386,
        REGRESSION_CASES_387_389,
        REGRESSION_CASES_390_395,
        REGRESSION_CASES_396,
        REGRESSION_CASES_397,
        REGRESSION_CASES_398_399,
        REGRESSION_CASES_410_411,
        REGRESSION_CASES_412,
        REGRESSION_CASES_413_414,
